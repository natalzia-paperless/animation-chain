  ...
  chainObj.prototype = {
    ...
    animationFinished: function() {
      if (this.ticks.length) {
        this.ticks[0].el.removeEventListener(this.ticks[0].animationName, this.animationFinished);
      ...
      if (this.ticks.length) {
        if (!this.ticks[0].el) {
          ...
          if (prop.singleListener) {
            ...
            el.removeEventListener(this.ticks[0].animationName, this.animationFinished);
          }
